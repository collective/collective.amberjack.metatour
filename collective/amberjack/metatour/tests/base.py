...
def setup_product():
    ...
    import collective.amberjack.metatour
    zcml.load_config('configure.zcml', collective.amberjack.metatour)
    ...
    ztc.installPackage('collective.amberjack.metatour')
...
setup_product()
ptc.setupPloneSite(products=['collective.amberjack.metatour'])
